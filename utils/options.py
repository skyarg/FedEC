...
def args_parser():
    ...
    parser.add_argument('--is_decay', type=int, default=0, help='how often to save models0106')
    ...
    parser.add_argument('--KL_label_weight', type=float, default=0.1, help='loss weight')
    parser.add_argument('--KL_feature_weight', type=float, default=0.1, help='loss weight')
    parser.add_argument('--l2_weight', type=float, default=0.1, help='l2 loss weight')
    parser.add_argument('--l2_type', type=str, default='ewc', help='l2 loss type')
    parser.add_argument('--max_T', type=int, default=20, help='max temperature in KD')
    parser.add_argument('--min_T', type=int, default=2, help='min temperature in KD')
    ...
    parser.add_argument("--gen_eps", type=int, default=20, help="gen_eps")
