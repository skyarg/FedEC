...
def test_img_local_all(net, args, dataset_test, dict_users_test, sampled_client_list, w_locals=None,w_glob_keys=None, indd=None,dataset_train=None,dict_users_train=None, return_all=False, iter=None):
    tot = 0
